...
### 3. Always verify AI legal output
...
### 4. Align with a cyber security standard
...
### 5. Verify money and data moves out of band
...
### 6. Lock down agents and inboxes
...
### Bonus: cross-check with a second model
